  ...
  return (
        ...
        <footer className="flex flex-col bg-slate-50 items-center justify-around w-full py-16 text-sm text-gray-800/70">
            <div className="flex items-center gap-8">
                <a href="#" className="text-lg text-gray-600 hover:text-black transition-all">
                    Home
                </a>
                <a href="#" className="text-lg text-gray-600 hover:text-black transition-all">
                    About
            ...
            <div className="flex items-center gap-4 mt-8 text-primary-dull">
            ...
            <p className="mt-8 text-center py-4 text-sm md:text-base text-gray-600/90">
                Copyright © {new Date().getFullYear()} <a className='text-gray-600 hover:text-black transition-all'>Sucesso Representações</a>. Todos os direitos reservados.
            </p>
        </footer>
